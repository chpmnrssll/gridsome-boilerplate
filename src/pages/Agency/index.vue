<template>
  <AgencyLayout>
    <section class="above-fold hero-section">
...
.hero-section {
  ...
  .background-image {
    ...
    &:after {
      background-image: linear-gradient(225deg, $deepBlue 0%, $greenish 65%);
      content: '';
      left: 0;
      height: 100%;
      position: absolute;
  ...
  .background-image__first {
    ...
    &:after {
      background-image: linear-gradient(225deg, $greenish 0%, $deepBlue 65%);
